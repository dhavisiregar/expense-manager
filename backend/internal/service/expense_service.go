...
func (s *ExpenseService) GetByID(ctx context.Context, id uuid.UUID) (*domain.Expense, error) {
...
func (s *ExpenseService) Update(ctx context.Context, id uuid.UUID, input domain.UpdateExpenseInput) (*domain.Expense, error) {
...
func (s *ExpenseService) GetDashboardSummary(ctx context.Context) (*domain.DashboardSummary, error) {
